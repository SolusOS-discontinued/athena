...
typedef GObject AthenaSignaller;
typedef GObjectClass AthenaSignallerClass;
...
static GType athena_signaller_get_type (void);

G_DEFINE_TYPE (AthenaSignaller, athena_signaller, G_TYPE_OBJECT);

GObject *
athena_signaller_get_current (void)
{
	static GObject *global_signaller = NULL;

	if (global_signaller == NULL) {
		global_signaller = g_object_new (athena_signaller_get_type (), NULL);
	}
...
static void
athena_signaller_init (AthenaSignaller *signaller)
{
}

static void
athena_signaller_class_init (AthenaSignallerClass *class)
{
