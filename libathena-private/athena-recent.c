...
athena_recent_get_manager (void)
{
...
void
athena_recent_add_file (AthenaFile *file,
			  GAppInfo *application)
{
	...
	recent_data.mime_type = athena_file_get_mime_type (file);
	...
	gtk_recent_manager_add_full (athena_recent_get_manager (),
				     uri, &recent_data);
