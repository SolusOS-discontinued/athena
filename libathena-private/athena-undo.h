...
/* athena-undo.h - public interface for objects that implement
...
#ifndef ATHENA_UNDO_H
#define ATHENA_UNDO_H

#include <glib-object.h>

typedef struct _AthenaUndoTransaction AthenaUndoTransaction;


/* The basic undoable operation. */
typedef void (* AthenaUndoCallback) (GObject *target, gpointer callback_data);
...
void athena_undo_register              (GObject              *target,
					  AthenaUndoCallback  callback,
					  gpointer              callback_data,
					  GDestroyNotify        callback_data_destroy_notify,
...
void athena_undo_register_full         (GList                *atoms,
					  ...
					  const char           *redo_menu_item_label,
					  const char           *redo_menu_item_hint);
void athena_undo_unregister            (GObject              *target);
 ...
 */
void athena_undo                       (GObject              *undo_manager_search_start_object);

/* Connecting an undo manager. */
void athena_undo_share_undo_manager    (GObject              *destination_object,
