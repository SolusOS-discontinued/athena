...
/* athena-connect-server-main.c - Start the "Connect to Server" dialog.
 * Athena
 *
...
main (int argc, char *argv[])
{
	...
	gtk_window_set_default_icon_name (ATHENA_ICON_FOLDER);

	dialog = athena_connect_server_dialog_new (NULL);
