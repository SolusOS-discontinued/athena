...
/* athena-main.c: Implementation of the routines that drive program lifecycle and main window creation/destruction. */
...
main (int argc, char *argv[])
{
	...
	/* Athena uses lots and lots of small and medium size allocations,
	 ...
	 * be mmaped. Unfortunately this triggers quickly for athena when
