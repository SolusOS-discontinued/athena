...
/* athena-self-check-functions.h: Wrapper and prototypes for all self
 * check functions in Athena proper.
 */
...
#define ATHENA_FOR_EACH_SELF_CHECK_FUNCTION(macro) \
/* Add new self-check functions to the list above this line. */

/* Generate prototypes for all the functions. */
ATHENA_FOR_EACH_SELF_CHECK_FUNCTION (ATHENA_SELF_CHECK_FUNCTION_PROTOTYPE)
