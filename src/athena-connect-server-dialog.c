...
struct _AthenaConnectServerDialogDetails {
...
G_DEFINE_TYPE (AthenaConnectServerDialog, athena_connect_server_dialog,
	       GTK_TYPE_DIALOG)
...
static void
connect_dialog_restore_info_bar (AthenaConnectServerDialog *dialog,
...
static void
connect_dialog_set_connecting (AthenaConnectServerDialog *dialog)
{
	GtkWidget *hbox;
	GtkWidget *widget;
...
static void
connect_dialog_gvfs_error (AthenaConnectServerDialog *dialog)
{
...
static void
iconize_entry (AthenaConnectServerDialog *dialog,
	       GtkWidget *entry)
{
...
static void
connect_dialog_set_info_bar_error (AthenaConnectServerDialog *dialog,
				   GError *error)
{
...
static void
connect_dialog_finish_fill (AthenaConnectServerDialog *dialog)
{
...
static void
connect_dialog_request_additional_details (AthenaConnectServerDialog *self,
					   GAskPasswordFlags flags,
			   ...
			   gpointer user_data)
{
	...
	athena_connect_server_dialog_display_location_finish (dialog,
								res, &error);
			  ...
			  gpointer user_data)
{
	...
	if (!error || g_error_matches (error, G_IO_ERROR, G_IO_ERROR_ALREADY_MOUNTED)) {
		...
		athena_connect_server_dialog_display_location_async (dialog, location,
...
static void
connect_dialog_present_uri_async (AthenaConnectServerDialog *self,
				  GFile *location)
{
	GMountOperation *op;
	...
	op = athena_connect_server_operation_new (self);
...
static void
connect_dialog_connect_to_server (AthenaConnectServerDialog *dialog)
{
...
static void
connect_to_server_or_finish_fill (AthenaConnectServerDialog *dialog)
{
...
static gboolean
connect_dialog_abort_mount_operation (AthenaConnectServerDialog *dialog)
{
...
static void
connect_dialog_destroy (AthenaConnectServerDialog *dialog)
{
...
static void
connect_dialog_response_cb (AthenaConnectServerDialog *dialog,
			    int response_id,
			    gpointer data)
{
	GError *error;
	...
	case GTK_RESPONSE_HELP :
		...
		gtk_show_uri (gtk_window_get_screen (GTK_WINDOW (dialog)),
			      "help:gnome-help/athena-connect",
...
static void
connect_dialog_cleanup (AthenaConnectServerDialog *dialog)
{
	/* hide the infobar */
...
static void
connect_dialog_setup_for_type (AthenaConnectServerDialog *dialog)
{
	struct MethodInfo *meth;
	int index;;
	GtkTreeIter iter;
...
static void
bind_visibility (AthenaConnectServerDialog *dialog,
		 GtkWidget *source,
		 GtkWidget *dest)
{
...
static void
athena_connect_server_dialog_init (AthenaConnectServerDialog *dialog)
{
	GtkWidget *label;
	GtkWidget *alignment;
	GtkWidget *content_area;
	...
	dialog->details = G_TYPE_INSTANCE_GET_PRIVATE (dialog, ATHENA_TYPE_CONNECT_SERVER_DIALOG,
						       AthenaConnectServerDialogDetails);
...
static void
athena_connect_server_dialog_finalize (GObject *object)
{
	AthenaConnectServerDialog *dialog;

	dialog = ATHENA_CONNECT_SERVER_DIALOG (object);
	...
	G_OBJECT_CLASS (athena_connect_server_dialog_parent_class)->finalize (object);
}

static void
athena_connect_server_dialog_class_init (AthenaConnectServerDialogClass *class)
{
	GObjectClass *oclass;

	oclass = G_OBJECT_CLASS (class);
	oclass->finalize = athena_connect_server_dialog_finalize;

	g_type_class_add_private (class, sizeof (AthenaConnectServerDialogDetails));
}

GtkWidget *
athena_connect_server_dialog_new (AthenaWindow *window)
{
	GtkWidget *dialog;

	dialog = gtk_widget_new (ATHENA_TYPE_CONNECT_SERVER_DIALOG, NULL);
...
gboolean
athena_connect_server_dialog_fill_details_finish (AthenaConnectServerDialog *self,
						    GAsyncResult *result)
{
...
void
athena_connect_server_dialog_fill_details_async (AthenaConnectServerDialog *self,
						   ...
						   gpointer user_data)
{
	...
	fill_details_res = g_simple_async_result_new (G_OBJECT (self), callback, user_data,
						      athena_connect_server_dialog_fill_details_async);
