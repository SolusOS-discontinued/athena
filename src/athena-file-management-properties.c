...
/* athena-file-management-properties.c - Functions to create and show the athena preference dialog.
...
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET "default_view_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET "icon_view_zoom_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET "compact_view_zoom_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET "list_view_zoom_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET "sort_order_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET "date_format_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET "preview_text_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET "preview_image_combobox"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET "preview_folder_combobox"

/* bool preferences */
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET "sort_folders_first_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET "labels_beside_icons_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH "all_columns_same_width_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET "always_use_browser_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET "trash_confirm_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET "trash_delete_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_OPEN_NEW_WINDOW_WIDGET "new_window_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET "hidden_files_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET "treeview_folders_checkbutton"

#define ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_UP_ICON_TOOLBAR_WIDGET "show_up_icon_toolbar_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_RELOAD_ICON_TOOLBAR_WIDGET "show_reload_icon_toolbar_checkbutton"
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_EDIT_ICON_TOOLBAR_WIDGET "show_edit_icon_toolbar_checkbutton"
...
/* int enums */
#define ATHENA_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET "preview_image_size_combobox"
...
static void
athena_file_management_properties_size_group_create (GtkBuilder *builder,
						       char *prefix,
						       int items)
{
...
static void
athena_file_management_properties_dialog_response_cb (GtkDialog *parent,
							int response_id,
							GtkBuilder *builder)
{
	char *section;
	...
	if (response_id == GTK_RESPONSE_HELP) {
		...
		default:
		case 0:
			section = "athena-views";
			break;
		case 1:
			section = "athena-behavior";
			break;
		case 2:
			section = "athena-display";
			break;
		case 3:
			section = "athena-list";
			break;
		case 4:
			section = "athena-preview";
			break;
		}
...
static void
columns_changed_callback (AthenaColumnChooser *chooser,
			  gpointer callback_data)
{
	char **visible_columns;
	char **column_order;

	athena_column_chooser_get_settings (ATHENA_COLUMN_CHOOSER (chooser),
					      &visible_columns,
					      &column_order);

	g_settings_set_strv (athena_list_view_preferences,
				...
				gpointer user_data)
{
	...
	g_settings_set_strv (athena_icon_view_preferences,
			     ATHENA_PREFERENCES_ICON_VIEW_CAPTIONS,
...
update_icon_captions_from_settings (GtkBuilder *builder)
{
	...
	captions = g_settings_get_strv (athena_icon_view_preferences, ATHENA_PREFERENCES_ICON_VIEW_CAPTIONS);
	if (captions == NULL)
		return;
...
static void
athena_file_management_properties_dialog_setup_icon_caption_page (GtkBuilder *builder)
{
	GList *columns;
	int i;
	gboolean writable;

	writable = g_settings_is_writable (athena_icon_view_preferences,
					   ATHENA_PREFERENCES_ICON_VIEW_CAPTIONS);

	columns = athena_get_common_columns ();
	...
	athena_column_list_free (columns);
...
create_date_format_menu (GtkBuilder *builder)
{
	...
	combo_box = GTK_COMBO_BOX_TEXT
		(gtk_builder_get_object (builder,
					 ATHENA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET));
...
static void
set_columns_from_settings (AthenaColumnChooser *chooser)
{
	char **visible_columns;
	char **column_order;

	visible_columns = g_settings_get_strv (athena_list_view_preferences,
					       ATHENA_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
	column_order = g_settings_get_strv (athena_list_view_preferences,
					    ATHENA_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);

	athena_column_chooser_set_settings (ATHENA_COLUMN_CHOOSER (chooser),
					      visible_columns,
					      column_order);
...
static void
use_default_callback (AthenaColumnChooser *chooser,
		      gpointer user_data)
{
	g_settings_reset (athena_list_view_preferences,
			  ATHENA_PREFERENCES_LIST_VIEW_DEFAULT_VISIBLE_COLUMNS);
	g_settings_reset (athena_list_view_preferences,
			  ATHENA_PREFERENCES_LIST_VIEW_DEFAULT_COLUMN_ORDER);
...
static void
athena_file_management_properties_dialog_setup_list_column_page (GtkBuilder *builder)
{
	GtkWidget *chooser;
	GtkWidget *box;

	chooser = athena_column_chooser_new (NULL);
	...
	set_columns_from_settings (ATHENA_COLUMN_CHOOSER (chooser));
...
static  void
athena_file_management_properties_dialog_setup (GtkBuilder *builder, GtkWindow *window)
{
	GtkWidget *dialog;

	/* setup UI */
	athena_file_management_properties_size_group_create (builder,
							       "views_label",
							       5);
	athena_file_management_properties_size_group_create (builder,
							       "captions_label",
	...
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_UP_ICON_TOOLBAR_WIDGET,
			   ATHENA_PREFERENCES_SHOW_UP_ICON_TOOLBAR);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_RELOAD_ICON_TOOLBAR_WIDGET,
			   ATHENA_PREFERENCES_SHOW_RELOAD_ICON_TOOLBAR);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_EDIT_ICON_TOOLBAR_WIDGET,
			   ATHENA_PREFERENCES_SHOW_EDIT_ICON_TOOLBAR);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_HOME_ICON_TOOLBAR_WIDGET,
			   ATHENA_PREFERENCES_SHOW_HOME_ICON_TOOLBAR);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_COMPUTER_ICON_TOOLBAR_WIDGET,
			   ATHENA_PREFERENCES_SHOW_COMPUTER_ICON_TOOLBAR);
	bind_builder_bool (builder, athena_preferences,
	...
	bind_builder_bool (builder, athena_icon_view_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_LABELS_BESIDE_ICONS_WIDGET,
			   ATHENA_PREFERENCES_ICON_VIEW_LABELS_BESIDE_ICONS);
	bind_builder_bool (builder, athena_compact_view_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_ALL_COLUMNS_SAME_WIDTH,
			   ATHENA_PREFERENCES_COMPACT_VIEW_ALL_COLUMNS_SAME_WIDTH);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_FOLDERS_FIRST_WIDGET,
			   ATHENA_PREFERENCES_SORT_DIRECTORIES_FIRST);
	bind_builder_bool_inverted (builder, athena_preferences,
				    ATHENA_FILE_MANAGEMENT_PROPERTIES_ALWAYS_USE_BROWSER_WIDGET,
				    ATHENA_PREFERENCES_ALWAYS_USE_BROWSER);

	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_TRASH_CONFIRM_WIDGET,
			   ATHENA_PREFERENCES_CONFIRM_TRASH);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_TRASH_DELETE_WIDGET,
			   ATHENA_PREFERENCES_ENABLE_DELETE);
	bind_builder_bool (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SHOW_HIDDEN_WIDGET,
			   ATHENA_PREFERENCES_SHOW_HIDDEN_FILES);

	bind_builder_bool (builder, athena_tree_sidebar_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_TREE_VIEW_FOLDERS_WIDGET,
			   ATHENA_PREFERENCES_TREE_SHOW_ONLY_DIRECTORIES);

	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_DEFAULT_VIEW_WIDGET,
			   ATHENA_PREFERENCES_DEFAULT_FOLDER_VIEWER,
			   (const char **) default_view_values);
	bind_builder_enum (builder, athena_icon_view_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_ICON_VIEW_ZOOM_WIDGET,
			   ATHENA_PREFERENCES_ICON_VIEW_DEFAULT_ZOOM_LEVEL,
			   (const char **) zoom_values);
	bind_builder_enum (builder, athena_compact_view_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_COMPACT_VIEW_ZOOM_WIDGET,
			   ATHENA_PREFERENCES_COMPACT_VIEW_DEFAULT_ZOOM_LEVEL,
			   (const char **) zoom_values);
	bind_builder_enum (builder, athena_list_view_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_LIST_VIEW_ZOOM_WIDGET,
			   ATHENA_PREFERENCES_LIST_VIEW_DEFAULT_ZOOM_LEVEL,
			   (const char **) zoom_values);
	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_SORT_ORDER_WIDGET,
			   ATHENA_PREFERENCES_DEFAULT_SORT_ORDER,
			   (const char **) sort_order_values);
	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_TEXT_WIDGET,
			   ATHENA_PREFERENCES_SHOW_TEXT_IN_ICONS,
			   (const char **) preview_values);
	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_IMAGE_WIDGET,
			   ATHENA_PREFERENCES_SHOW_IMAGE_FILE_THUMBNAILS,
			   (const char **) preview_values);
	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_PREVIEW_FOLDER_WIDGET,
			   ATHENA_PREFERENCES_SHOW_DIRECTORY_ITEM_COUNTS,
			   (const char **) preview_values);
	bind_builder_enum (builder, athena_preferences,
			   ATHENA_FILE_MANAGEMENT_PROPERTIES_DATE_FORMAT_WIDGET,
	...
	bind_builder_radio (builder, athena_preferences,
	...
	bind_builder_radio (builder, athena_preferences,
			    ...
			    ATHENA_PREFERENCES_EXECUTABLE_TEXT_ACTIVATION,
			    (const char **) executable_text_values);

	bind_builder_uint_enum (builder, athena_preferences,
				ATHENA_FILE_MANAGEMENT_PROPERTIES_THUMBNAIL_LIMIT_WIDGET,
				ATHENA_PREFERENCES_IMAGE_FILE_THUMBNAIL_LIMIT,
				thumbnail_limit_values,
				G_N_ELEMENTS (thumbnail_limit_values));

	athena_file_management_properties_dialog_setup_icon_caption_page (builder);
	athena_file_management_properties_dialog_setup_list_column_page (builder);

	/* UI callbacks */
	dialog = GTK_WIDGET (gtk_builder_get_object (builder, "file_management_dialog"));
	g_signal_connect_data (dialog, "response",
			       G_CALLBACK (athena_file_management_properties_dialog_response_cb),
...
void
athena_file_management_properties_dialog_show (GtkWindow *window)
{
	GtkBuilder *builder;
